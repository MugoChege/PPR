...
nums = [0,0,5]
len_nums = len(nums)
num_nums = number_from_array(nums)
nums.sort()
nums.reverse()
upper_limit_num_nums = number_from_array(nums)
print(num_nums)
print(upper_limit_num_nums)
...
while running_number <= upper_limit_num_nums:
	...
	if (array_comparison(temp_nums_array, nums) and (running_number != num_nums)):
		next_permutation = temp_nums_array
		break
		
	running_number += 1
		
print(next_permutation, end = "\n\n\n")
