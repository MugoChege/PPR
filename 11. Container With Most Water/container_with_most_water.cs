...
namespace container_with_most_water_ns
{
	class container_with_most_water_c
	{
		public struct HeightValues{
			public int height1;
			public int height2;
		}
		...
		public static void Main (string [] args){
			...
			Console.WriteLine($"[{height_indices.heightPoint1}, {height_indices.heightPoint2}]\n\n");
			
			Console.WriteLine($"The heights given the points are: {height1} on one end and {height2} on the other end. The difference between the two points is {interval} giving a total volume of {get_volume(height1, height2, interval)}\n\n");
		}
	}
}
